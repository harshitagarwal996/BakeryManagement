...
class Bakery(Model):
    ...
    phone_number = models.CharField(max_length=10, null=True, blank=True, validators=[validators.MinLengthValidator(10),
...
class Ingredient(Model):
    ...
    inventory = models.ForeignKey(Inventory, null=False, blank=False, related_name="ingredients",
...
class IngredientQuantityMapping(Model):
    ...
    product = models.ForeignKey(Product, related_name="ingredient_quantity_mappings", null=False, blank=False,
                                on_delete=models.CASCADE)
